<template>
  <Authenticated-layout>
    <div class="py-12">
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <a-row :gutter="16">
          <a-col :xs="24" :sm="24" :md="18" :lg="18" class="left-column">
            <div class="container">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
              ...
              >
                ...
                <a-descriptions-item label="Floor Number">{{
                  details.floorNumber
                }}</a-descriptions-item>
                <a-descriptions-item label="Room Number">{{
                  details.roomNumber
                }}</a-descriptions-item>
                <a-descriptions-item label="Area">{{
                  details.area
                }}</a-descriptions-item>
                <a-descriptions-item label="Apartment Type">{{
          ...
          <a-col :xs="24" :sm="24" :md="6" :lg="6" class="right-column">
            <!-- Timeline component -->
            <a-descriptions title="Apartment Timeline"></a-descriptions>
            <a-timeline>
              <a-timeline-item
                ...
                :color="item.color"
              >
                <template v-if="item.dotTemplate" #dot>
                  <!-- Custom dot (icon) can be inserted here -->
                </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { listData, details, isModalVisible, listData };
  },
});
</script>
